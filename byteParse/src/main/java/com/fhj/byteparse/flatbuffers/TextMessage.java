...
public final class TextMessage extends Table {
  ...
  public static TextMessage getRootAsTextMessage(ByteBuffer _bb, TextMessage obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static void startTextMessage(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public TextMessage get(int j) { return get(new TextMessage(), j); }
    public TextMessage get(TextMessage obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
